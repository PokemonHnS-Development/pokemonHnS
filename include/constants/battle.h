...
#define BATTLE_TYPE_RAID               (1 << 12) // BATTLE_TYPE_KYOGRE_GROUDON in HnS
#define BATTLE_TYPE_LEGENDARY          (1 << 13)
#define BATTLE_TYPE_14                 (1 << 14) // BATTLE_TYPE_REGI in HnS
...
#define BATTLE_TYPE_28                 (1 << 28) // BATTLE_TYPE_GROUDON in HnS
#define BATTLE_TYPE_29                 (1 << 29) // BATTLE_TYPE_KYOGRE in HnS
#define BATTLE_TYPE_30                 (1 << 30) // BATTLE_TYPE_RAYQUAZA in HnS
...
#define HITMARKER_UNUSED_1              (1 << 4) // now marked unused - "Cleared when waking up. Never set or checked."
...
#define B_WIN_PP                  7
#define B_WIN_DUMMY               8 // HnS - previously B_WIN_PSS_ICON
