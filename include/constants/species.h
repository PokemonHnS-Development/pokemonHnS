...
// These are extended species IDs beyond the normal dex, used only during battle.
// They are defined after the Unown forms so they don't collide with normal species.
#define SPECIES_MEGA_FIRST       (SPECIES_UNOWN_QMARK + 1)

#define SPECIES_VENUSAUR_MEGA    (SPECIES_MEGA_FIRST + 0)
#define SPECIES_CHARIZARD_MEGA_X (SPECIES_MEGA_FIRST + 1)
#define SPECIES_CHARIZARD_MEGA_Y (SPECIES_MEGA_FIRST + 2)
#define SPECIES_BLASTOISE_MEGA   (SPECIES_MEGA_FIRST + 3)
#define SPECIES_ALAKAZAM_MEGA    (SPECIES_MEGA_FIRST + 4)
#define SPECIES_GENGAR_MEGA      (SPECIES_MEGA_FIRST + 5)
#define SPECIES_KANGASKHAN_MEGA  (SPECIES_MEGA_FIRST + 6)
#define SPECIES_PINSIR_MEGA      (SPECIES_MEGA_FIRST + 7)
#define SPECIES_GYARADOS_MEGA    (SPECIES_MEGA_FIRST + 8)
#define SPECIES_AERODACTYL_MEGA  (SPECIES_MEGA_FIRST + 9)
#define SPECIES_MEWTWO_MEGA_X    (SPECIES_MEGA_FIRST + 10)
#define SPECIES_MEWTWO_MEGA_Y    (SPECIES_MEGA_FIRST + 11)
#define SPECIES_AMPHAROS_MEGA    (SPECIES_MEGA_FIRST + 12)
#define SPECIES_SCIZOR_MEGA      (SPECIES_MEGA_FIRST + 13)
#define SPECIES_HERACROSS_MEGA   (SPECIES_MEGA_FIRST + 14)
#define SPECIES_HOUNDOOM_MEGA    (SPECIES_MEGA_FIRST + 15)
#define SPECIES_TYRANITAR_MEGA   (SPECIES_MEGA_FIRST + 16)
#define SPECIES_BLAZIKEN_MEGA    (SPECIES_MEGA_FIRST + 17)
#define SPECIES_GARDEVOIR_MEGA   (SPECIES_MEGA_FIRST + 18)
#define SPECIES_MAWILE_MEGA      (SPECIES_MEGA_FIRST + 19)
#define SPECIES_AGGRON_MEGA      (SPECIES_MEGA_FIRST + 20)
#define SPECIES_MEDICHAM_MEGA    (SPECIES_MEGA_FIRST + 21)
#define SPECIES_MANECTRIC_MEGA   (SPECIES_MEGA_FIRST + 22)
#define SPECIES_SHARPEDO_MEGA    (SPECIES_MEGA_FIRST + 23)
#define SPECIES_CAMERUPT_MEGA    (SPECIES_MEGA_FIRST + 24)
#define SPECIES_ALTARIA_MEGA     (SPECIES_MEGA_FIRST + 25)
#define SPECIES_BANETTE_MEGA     (SPECIES_MEGA_FIRST + 26)
#define SPECIES_ABSOL_MEGA       (SPECIES_MEGA_FIRST + 27)
#define SPECIES_GLALIE_MEGA      (SPECIES_MEGA_FIRST + 28)
#define SPECIES_SALAMENCE_MEGA   (SPECIES_MEGA_FIRST + 29)
#define SPECIES_METAGROSS_MEGA   (SPECIES_MEGA_FIRST + 30)
#define SPECIES_LATIAS_MEGA      (SPECIES_MEGA_FIRST + 31)
#define SPECIES_LATIOS_MEGA      (SPECIES_MEGA_FIRST + 32)
#define SPECIES_GALLADE_MEGA     (SPECIES_MEGA_FIRST + 33)
#define SPECIES_RAYQUAZA_MEGA    (SPECIES_MEGA_FIRST + 34)
// Primal forms
#define SPECIES_KYOGRE_PRIMAL    (SPECIES_MEGA_FIRST + 35)
#define SPECIES_GROUDON_PRIMAL   (SPECIES_MEGA_FIRST + 36)
// Additional Mega forms (Gen 6 second wave)
#define SPECIES_BEEDRILL_MEGA    (SPECIES_MEGA_FIRST + 37)
#define SPECIES_PIDGEOT_MEGA     (SPECIES_MEGA_FIRST + 38)
#define SPECIES_SLOWBRO_MEGA     (SPECIES_MEGA_FIRST + 39)
#define SPECIES_STEELIX_MEGA     (SPECIES_MEGA_FIRST + 40)
#define SPECIES_SCEPTILE_MEGA    (SPECIES_MEGA_FIRST + 41)
#define SPECIES_SWAMPERT_MEGA    (SPECIES_MEGA_FIRST + 42)
#define SPECIES_SABLEYE_MEGA     (SPECIES_MEGA_FIRST + 43)
#define SPECIES_LOPUNNY_MEGA     (SPECIES_MEGA_FIRST + 44)
#define SPECIES_GARCHOMP_MEGA    (SPECIES_MEGA_FIRST + 45)
#define SPECIES_LUCARIO_MEGA     (SPECIES_MEGA_FIRST + 46)
#define SPECIES_ABOMASNOW_MEGA   (SPECIES_MEGA_FIRST + 47)
#define SPECIES_AUDINO_MEGA      (SPECIES_MEGA_FIRST + 48)
#define SPECIES_DIANCIE_MEGA     (SPECIES_MEGA_FIRST + 49)

#define SPECIES_MEGA_LAST        SPECIES_DIANCIE_MEGA
#define NUM_MEGA_SPECIES         (SPECIES_MEGA_LAST - SPECIES_MEGA_FIRST + 1)
