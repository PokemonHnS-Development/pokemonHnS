...
enum ItemHoldEffect
{
    ...
    // Hard Mode hold effects
    HOLD_EFFECT_HARD_MODE_MODIFIER,
    HOLD_EFFECT_HARD_MODE_MODIFIER_SITRUS,
    HOLD_EFFECT_HARD_MODE_MODIFIER_CHESTO,
    HOLD_EFFECT_HARD_MODE_MODIFIER_LEFTOVERS,
    HOLD_EFFECT_HARD_MODE_MODIFIER_LIECHI
};
