...
enum StringID
{
    ...
    STRINGID_ONETYPECAPTUREBLOCKED,
    STRINGID_NUZLOCKECAPTUREBLOCKED,
    STRINGID_SPECIESCLAUSECAPTUREBLOCKED,
    STRINGID_SAMESPECIESCAPTUREBLOCKED,
    STRINGID_PKMNGAINEDEXPALL,
...
enum CaughtMonStringID
{
    ...
    // "Bill's" should always follow "someone's"
...
enum FirstTurnOfTwoStringIds
{
    B_MSG_TURN1_RAZOR_WIND,
    B_MSG_TURN1_SOLAR_BEAM,
    B_MSG_TURN1_SKULL_BASH,
    B_MSG_TURN1_SKY_ATTACK,
    B_MSG_TURN1_FLY,
    B_MSG_TURN1_DIG,
    B_MSG_TURN1_DIVE,
    B_MSG_TURN1_BOUNCE,
    // TODO - this list, if still used, is incomplete
};
