...
#define TX_MODE_INFINITE_TMS 1
#define TX_MODE_SURVIVE_POISON 1
...
#define TX_MODE_NEW_SYNCHRONIZE 1
#define TX_MODE_MINTS 1
#define TX_MODE_NEW_CITRUS 1
#define TX_MODE_MODERN_TYPES 0
#define TX_MODE_FAIRY_TYPES 1
#define TX_MODE_NEW_STATS 0
#define TX_MODE_STURDY 1
#define TX_MODE_MODERN_MOVES 1
#define TX_MODE_LEGENDARY_ABILITIES 1
...
#define TX_MODE_TYPE_EFFECTIVENESS 1
