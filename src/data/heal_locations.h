...
static const struct HealLocation sHealLocations[NUM_HEAL_LOCATIONS - 1] = {
    ...
    [HEAL_LOCATION_OLIVINE_CITY - 1] = {
        .mapGroup = MAP_GROUP(MAP_OLIVINE_CITY),
        .mapNum = MAP_NUM(MAP_OLIVINE_CITY),
        .x = 15,
        .y = 44,
    },
    [HEAL_LOCATION_CIANWOOD_CITY - 1] = {
        .mapGroup = MAP_GROUP(MAP_CIANWOOD_CITY),
        .mapNum = MAP_NUM(MAP_CIANWOOD_CITY),
        .x = 31,
        .y = 46,
    },
    [HEAL_LOCATION_MAHOGANYTOWN - 1] = {
        .mapGroup = MAP_GROUP(MAP_MAHOGANYTOWN),
        .mapNum = MAP_NUM(MAP_MAHOGANYTOWN),
        .x = 21,
        .y = 20,
    },
    [HEAL_LOCATION_BLACKTHORN_CITY - 1] = {
    ...
    [HEAL_LOCATION_MT_SILVER - 1] = {
        .mapGroup = MAP_GROUP(MAP_MT_SILVER),
        .mapNum = MAP_NUM(MAP_MT_SILVER),
        .x = 25,
        .y = 15,
    },
    [HEAL_LOCATION_LAKE_OF_RAGE - 1] = {
        .mapGroup = MAP_GROUP(MAP_LAKE_OF_RAGE),
        .mapNum = MAP_NUM(MAP_LAKE_OF_RAGE),
        .x = 31,
        .y = 43,
    },
    [HEAL_LOCATION_INDIGO_PLATEAU - 1] = {
        .mapGroup = MAP_GROUP(MAP_INDIGO_PLATEAU),
        .mapNum = MAP_NUM(MAP_INDIGO_PLATEAU),
        .x = 11,
        .y = 7,
    },
    [HEAL_LOCATION_SAFARI_ZONE_GATE - 1] = {
        .mapGroup = MAP_GROUP(MAP_SAFARI_ZONE_GATE),
        .mapNum = MAP_NUM(MAP_SAFARI_ZONE_GATE),
        .x = 11,
        .y = 16,
    },
    [HEAL_LOCATION_NEW_MAP1 - 1] = {
        .mapGroup = MAP_GROUP(MAP_NEW_MAP1),
        .mapNum = MAP_NUM(MAP_NEW_MAP1),
        .x = 22,
        .y = 18,
    },
    ...
    [HEAL_LOCATION_PLAYERS_HOUSE2 - 1] = {
        .mapGroup = MAP_GROUP(MAP_PLAYERS_HOUSE2),
        .mapNum = MAP_NUM(MAP_PLAYERS_HOUSE2),
        .x = 4,
        .y = 4,
    },
    [HEAL_LOCATION_ROUTE_32 - 1] = {
        .mapGroup = MAP_GROUP(MAP_ROUTE32),
        .mapNum = MAP_NUM(MAP_ROUTE32),
        .x = 25,
        .y = 85,
    },
    [HEAL_LOCATION_ROUTE26NORTH - 1] = {
        .mapGroup = MAP_GROUP(MAP_ROUTE26NORTH),
        .mapNum = MAP_NUM(MAP_ROUTE26NORTH),
        .x = 12,
        .y = 6,
    },
};
