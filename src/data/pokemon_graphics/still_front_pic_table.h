...
SPECIES_SPRITE(VENUSAUR_MEGA, gMonStillFrontPic_VenusaurMega),
    ...
    SPECIES_SPRITE(GALLADE_MEGA, gMonStillFrontPic_GalladeMega),
    SPECIES_SPRITE(RAYQUAZA_MEGA, gMonStillFrontPic_RayquazaMega),
    SPECIES_SPRITE(KYOGRE_PRIMAL, gMonStillFrontPic_KyogrePrimal),
    SPECIES_SPRITE(GROUDON_PRIMAL, gMonStillFrontPic_GroudonPrimal),
    ...
    SPECIES_SPRITE(LOPUNNY_MEGA, gMonStillFrontPic_LopunnyMega),
    SPECIES_SPRITE(GARCHOMP_MEGA, gMonStillFrontPic_GarchompMega),
    SPECIES_SPRITE(LUCARIO_MEGA, gMonStillFrontPic_LucarioMega),
    SPECIES_SPRITE(ABOMASNOW_MEGA, gMonStillFrontPic_AbomasnowMega),
    SPECIES_SPRITE(AUDINO_MEGA, gMonStillFrontPic_AudinoMega),
    SPECIES_SPRITE(DIANCIE_MEGA, gMonStillFrontPic_DianceMega),
