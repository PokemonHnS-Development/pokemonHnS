...
const u32 gItemIcon_Sableyite[] = INCBIN_U32("graphics/items/icons/sableyite.4bpp.lz");
const u32 gItemIconPalette_Sableyite[] = INCBIN_U32("graphics/items/icon_palettes/sableyite.gbapal.lz");
const u32 gItemIcon_RedOrbPrimal[] = INCBIN_U32("graphics/items/icons/red_orb_primal.4bpp.lz");
const u32 gItemIconPalette_RedOrbPrimal[] = INCBIN_U32("graphics/items/icon_palettes/red_orb_primal.gbapal.lz");
const u32 gItemIcon_BlueOrbPrimal[] = INCBIN_U32("graphics/items/icons/blue_orb_primal.4bpp.lz");
const u32 gItemIconPalette_BlueOrbPrimal[] = INCBIN_U32("graphics/items/icon_palettes/blue_orb_primal.gbapal.lz");
