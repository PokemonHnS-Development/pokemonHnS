...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ANDRES] = REMATCH(TRAINER_BRIANA, TRAINER_BROOKE, TRAINER_BURT, TRAINER_CALVIN, TRAINER_CAMERON, MAP_ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_KRISE, TRAINER_KUNI, TRAINER_KYLE, TRAINER_LAO, TRAINER_LEA_AND_PIA, MAP_ROUTE111),
    ...
    [REMATCH_CRISTIN] = REMATCH(TRAINER_HILLARY, TRAINER_HORTON, TRAINER_IAN, TRAINER_IRWIN, TRAINER_ISSAC, MAP_ROUTE121),
    [REMATCH_BROOKE] = REMATCH(TRAINER_EMMA, TRAINER_ERICK, TRAINER_ERIK, TRAINER_ERIN, TRAINER_ERNEST, MAP_ROUTE111),
    ...
    [REMATCH_CINDY] = REMATCH(TRAINER_GRUNT_18, TRAINER_GRUNT_20, TRAINER_GRUNT_21, TRAINER_GRUNT_22, TRAINER_GRUNT_23, MAP_ROUTE104),
    ...
    [REMATCH_JESSICA] = REMATCH(TRAINER_ARIANA_1, TRAINER_ARIANA_2, TRAINER_JESSICA_3, TRAINER_JESSICA_4, TRAINER_JESSICA_5, MAP_ROUTE121),
    ...
    [REMATCH_ETHAN] = REMATCH(TRAINER_NAOKO, TRAINER_NATHAN, TRAINER_NEAL, TRAINER_NICK, TRAINER_NICO, MAP_JAGGED_PASS),
    ...
    [REMATCH_ISABEL] = REMATCH(TRAINER_LTSURGE, TRAINER_ERIKA, TRAINER_SABRINA, TRAINER_JANINE, TRAINER_BLAINE, MAP_ROUTE110),
    ...
    [REMATCH_CALVIN] = REMATCH(TRAINER_EUGENE, TRAINER_FIDEL, TRAINER_FRAN, TRAINER_FRITZ, TRAINER_GAKU, MAP_ROUTE102),
    [REMATCH_ELLIOT] = REMATCH(TRAINER_MASA, TRAINER_MATHEW, TRAINER_MEG_AND_PEG, TRAINER_MEGAN, TRAINER_MICHAEL, MAP_ROUTE106),
    ...
    [REMATCH_DIANA] = REMATCH(TRAINER_KAZU, TRAINER_KEITH, TRAINER_KELLY, TRAINER_KEN, TRAINER_KEANDRA, MAP_JAGGED_PASS),
    [REMATCH_AMY_AND_LIV] = REMATCH(TRAINER_AMY_AND_MAY, TRAINER_ANN_AND_ANNE, TRAINER_AMY_AND_LIV_4, TRAINER_AMY_AND_LIV_5, TRAINER_AMY_AND_LIV_6, MAP_ROUTE103),
    [REMATCH_ERNEST] = REMATCH(TRAINER_MIKE, TRAINER_MIKEY, TRAINER_MIKI, TRAINER_MILLER, TRAINER_MITCH, MAP_ROUTE125),
    [REMATCH_CORY] = REMATCH(TRAINER_GRUNT_29, TRAINER_HAL, TRAINER_HANK, TRAINER_HAROLD, TRAINER_HARRIS, MAP_ROUTE108),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_ROD, TRAINER_RON, TRAINER_ROSS, TRAINER_ROXANNE, TRAINER_ROY, MAP_MT_PYRE_3F),
    ...
    [REMATCH_HALEY] = REMATCH(TRAINER_WHITNEY_1, TRAINER_WHITNEY_2, TRAINER_MORTY_1, TRAINER_MORTY_2, TRAINER_PRYCE_1, MAP_ROUTE104),
    [REMATCH_JAMES] = REMATCH(TRAINER_RIVAL_CYNDAQUIL_4, TRAINER_RIVAL_CYNDAQUIL_5, TRAINER_RIVAL_CYNDAQUIL_6, TRAINER_RIVAL_CYNDAQUIL_7, TRAINER_RIVAL_TOTODILE_1, MAP_PETALBURG_WOODS),
    ...
    [REMATCH_BRAWLY] = REMATCH(TRAINER_DICK, TRAINER_DIRK, TRAINER_DON, TRAINER_DORIS, TRAINER_EDNA, MAP_DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_WATTSON_1, TRAINER_WATTSON_4, TRAINER_WATTSON_4, TRAINER_WATTSON_4, TRAINER_WATTSON_5, MAP_MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_PING, TRAINER_QUENTIN, TRAINER_QUINN, TRAINER_RACHAEL, TRAINER_RALPH, MAP_LAVARIDGE_TOWN),
    ...
    [REMATCH_DRAKE] = REMATCH(TRAINER_KIP, TRAINER_KIP, TRAINER_KIP, TRAINER_KIP, TRAINER_KIP, MAP_EVER_GRANDE_CITY),
...
u8 BattleSetup_GetTerrainId(void)
{
    ...
    {
        if (
            IS_MAP(MAP_BLACKTHORN_CITY,         MAP_BLACKTHORN_CITY) ||
            IS_MAP(MAP_CIANWOOD_CITY,           MAP_CIANWOOD_CITY) ||
            IS_MAP(MAP_DRAGONS_DEN2,            MAP_DRAGONS_DEN2) ||
            ...
            IS_MAP(MAP_MT_MORTAR3,              MAP_MT_MORTAR3) ||
            IS_MAP(MAP_MT_MORTAR4,              MAP_MT_MORTAR4) ||
            IS_MAP(MAP_MT_SILVER,               MAP_MT_SILVER) ||
            IS_MAP(MAP_MT_SILVER5,              MAP_MT_SILVER5) ||
            IS_MAP(MAP_MT_SILVER6,              MAP_MT_SILVER6) ||
            IS_MAP(MAP_MT_SILVER7,              MAP_MT_SILVER7) ||
            IS_MAP(MAP_MT_SILVER8,              MAP_MT_SILVER8) ||
            ...
            IS_MAP(MAP_RUINS_OF_ALPH,           MAP_RUINS_OF_ALPH) ||
            ...
            IS_MAP(MAP_WHIRL_ISLANDS1,          MAP_WHIRL_ISLANDS1) ||
            IS_MAP(MAP_MT_SILVER_SIDE_TEST,     MAP_MT_SILVER_SIDE_TEST) ||
        ...
        if (IS_MAP(MAP_FUCHSIA, MAP_FUCHSIA) || IS_MAP(MAP_CINNABAR_ISLAND, MAP_CINNABAR_ISLAND))
    ...
    case MAP_TYPE_UNDERGROUND:
       ...
       /* if (MetatileBehavior_IsSurfableWaterOrUnderwater(tileBehavior))
        ...
        {*/
        if (
            IS_MAP(MAP_CERULEAN_CAVE1,              MAP_CERULEAN_CAVE1) ||
            IS_MAP(MAP_CERULEAN_CAVE2,              MAP_CERULEAN_CAVE2) ||
            IS_MAP(MAP_CERULEAN_CAVE3,              MAP_CERULEAN_CAVE3) ||
            IS_MAP(MAP_WHIRL_ISLANDS1,              MAP_WHIRL_ISLANDS1) ||
            IS_MAP(MAP_WHIRL_ISLANDS2,              MAP_WHIRL_ISLANDS2) ||
            IS_MAP(MAP_WHIRL_ISLANDS3,              MAP_WHIRL_ISLANDS3) ||
            IS_MAP(MAP_SEAFOAM_ISLANDS1,            MAP_SEAFOAM_ISLANDS1) ||
            IS_MAP(MAP_SEAFOAM_ISLANDS2,            MAP_SEAFOAM_ISLANDS2) ||
            IS_MAP(MAP_SEAFOAM_ISLANDS3,            MAP_SEAFOAM_ISLANDS3) ||
            IS_MAP(MAP_MT_SILVER1,                  MAP_MT_SILVER1) ||
            IS_MAP(MAP_MT_SILVER2,                  MAP_MT_SILVER2) ||
            IS_MAP(MAP_MT_SILVER4,                  MAP_MT_SILVER4) ||
            IS_MAP(MAP_MT_SILVER6,                  MAP_MT_SILVER6) ||
            IS_MAP(MAP_MT_SILVER8,                  MAP_MT_SILVER8) ||
            IS_MAP(MAP_ICE_PATH1,                   MAP_ICE_PATH1) ||
            IS_MAP(MAP_ICE_PATH2,                   MAP_ICE_PATH2) ||
            IS_MAP(MAP_ICE_PATH3,                   MAP_ICE_PATH3) ||
            IS_MAP(MAP_ICE_PATH4,                   MAP_ICE_PATH4) ||
            IS_MAP(MAP_ICE_PATH5,                   MAP_ICE_PATH5) ||
            IS_MAP(MAP_MT_MORTAR1,                  MAP_MT_MORTAR1) ||
            IS_MAP(MAP_MT_MORTAR2,                  MAP_MT_MORTAR2) ||
            IS_MAP(MAP_MT_MORTAR3,                  MAP_MT_MORTAR3) ||
            IS_MAP(MAP_MT_MORTAR4,                  MAP_MT_MORTAR4) ||
            IS_MAP(MAP_DRAGONS_DEN1,                MAP_DRAGONS_DEN1) ||
            IS_MAP(MAP_DRAGONS_DEN2,                MAP_DRAGONS_DEN2) ||
            IS_MAP(MAP_ROCK_TUNNEL1,                MAP_ROCK_TUNNEL1) ||
            IS_MAP(MAP_ROCK_TUNNEL2,                MAP_ROCK_TUNNEL2) ||
            IS_MAP(MAP_SLOWPOKE_WELL,               MAP_SLOWPOKE_WELL) ||
            IS_MAP(MAP_SLOWPOKE_WELL2,              MAP_SLOWPOKE_WELL2) ||
            IS_MAP(MAP_SAFARI_ZONE_LOW_RIGHT,       MAP_SAFARI_ZONE_LOW_RIGHT) ||
            IS_MAP(MAP_FUCHSIA_SAFARI_ZONE_CAVE,    MAP_FUCHSIA_SAFARI_ZONE_CAVE))
        {
    ...
    case MAP_TYPE_SECRET_BASE:
        return BATTLE_TERRAIN_BUILDING;
        if (
                IS_MAP(MAP_BLACKTHORN_GYM1, MAP_BLACKTHORN_GYM1))
            {
                return BATTLE_TERRAIN_CAVE;
            }
