...
void SetBattleFacilityTrainerGfxId(u16 trainerId, u8 tempVarId)
{
    ...
    case 0:
    default:
        VarSet(VAR_OBJ_GFX_ID_0, OBJ_EVENT_GFX_MR_FUJI);
        return;
    case 1:
        VarSet(VAR_OBJ_GFX_ID_1, OBJ_EVENT_GFX_MR_FUJI);
        return;
    case 15:
        VarSet(VAR_OBJ_GFX_ID_E, OBJ_EVENT_GFX_MR_FUJI);
        return;
    }
}
