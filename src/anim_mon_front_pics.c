...
// === Mega Evolution & Primal Forms (no separate anim frame; use front.4bpp.lz) ===
...
const u32 gMonFrontPic_DianceMega[] = INCBIN_U32("graphics/pokemon/diancie/mega/front.4bpp.lz");
